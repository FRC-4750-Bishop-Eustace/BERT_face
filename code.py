...
DEFAULT_FRAME_DURATION = 0.09 # 100ms
...
## When you mount the IMU, will need to test & note down the X, Y, Z orientation, use the movement_test parameter to test
'''
Forward acceleration is:
 if X, mpu.acceleration[0]
 if Y, mpu.acceleration[1]
 if Z, mpu.acceleration[2]
